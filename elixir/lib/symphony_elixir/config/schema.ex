defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Team do
    ...
    @primary_key false
    embedded_schema do
      field(:repositories, :map, default: %{})
    end

    @spec changeset(%__MODULE__{}, map()) :: Ecto.Changeset.t()
    def changeset(schema, attrs) do
      cast(schema, attrs, [:repositories], empty_values: [])
    end
  end
  ...
  embedded_schema do
    ...
    embeds_one(:team, Team, on_replace: :update, defaults_to_struct: true)
  ...
  defp changeset(attrs) do
    ...
    |> cast_embed(:team, with: &Team.changeset/2)
