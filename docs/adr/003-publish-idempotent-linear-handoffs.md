...
Completed-work handoff comments and workflow state are externally visible writes. Agent-owned
...
marker and caller-supplied UUIDv4 Linear comment ID. Current-run proof event IDs remain validation
